...
public class PeachActivity extends AppCompatActivity implements
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.btn_one) {    //第一个桃子的点击事件
            info(btn_one);
        } else if (view.getId() == R.id.btn_two) {    //第二个桃子的点击事件
            info(btn_two);
        } else if (view.getId() == R.id.btn_three) {  //第三个桃子的点击事件
            info(btn_three);
        } else if (view.getId() == R.id.btn_four) {   //第四个桃子的点击事件
            info(btn_four);
        } else if (view.getId() == R.id.btn_five) {   //第五个桃子的点击事件
            info(btn_five);
        } else if (view.getId() == R.id.btn_six) {    //第六个桃子的点击事件
            info(btn_six);
        } else if (view.getId() == R.id.btn_exit) {   //“退出桃园”按钮的点击事件
            returnData();
        }
    }
